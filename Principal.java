...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        do { // inicio do código 
                    ...
                    for (int i = 0; i < 8; i++) {
                        for (int j = 0; j < 2; j++) {
                            if (j == 0) {
                                ...
                                receita2[i][j] = recebeQuantidadeProduto2(i);
            ...
            System.out.printf("\n\nQual o preço de venda do bolo no pote ? ");
            valor_venda = RecebeValor();

            lucro_real = valor_venda - custo_unitario;
            lucro_porcent = (lucro_real / custo_unitario) * 100;

            if (custo_receita < 30.0) {
                mensagemDestacada("A receita é viável !!");
            } else {
                mensagemDestacada("A receita não é viável !!");
            }
            ...
            // FIM Fase4_Etapa3 -------------------------------------------------------------------
            //
            /* Fase5_Etapa1 (FINAL) Miguel Neto-------------------------------------------------------------------
             ...
             */
            // pergunta Final, se não, fim do codigo!
            System.out.print("\nDeseja Analisar uma nova receita ?  (S)SIM (N)NÃO > ");
        ...
        // FIM Fase5_Etapa1 (FINAL) Miguel Neto -------------------------------------------------------------------
    }
    ...
    /**
     * Imprime uma mensagem em destaque, no console.
     *
     * Cortesia para os colegas estudarem como funciona o desenho de bordas ;)
     *
     * Baseado no projeto: https://github.com/Viniciusalopes/tela_console_java
     *
     * @param mensagem Texto a ser impresso na mensagem
     * @author Vovolinux
     */
    private static void mensagemDestacada(String mensagem) {
